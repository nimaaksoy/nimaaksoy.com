...
export const metadata: Metadata = {
  title: "Nima Aksoy Today Privacy Policy",
  description:
    "Privacy policy for Nima Aksoy Today, including Google Calendar access, local browser storage, and the planned Chrome new-tab extension.",
  alternates: {
      ...
      <div className="mx-auto max-w-3xl px-6 py-14 md:py-20">
        <article className="space-y-10 font-monroe text-[15px] leading-7 text-[#B8B8B8]">
          ...
          <section className={sectionClassName}>
            ...
            <p>
              Nima Aksoy Today is a local-first daily dashboard created by Nima Aksoy. It
          ...
          <section className={sectionClassName}>
            ...
            <p>
              Google Calendar connection is optional. If you connect it, Nima Aksoy Today requests
            ...
            <p>
              Nima Aksoy Today does not create, edit, delete, sell, transfer, or share your Google
            ...
            <p>
              Nima Aksoy Today&apos;s use of information received from Google Workspace APIs will
          ...
          <section className={sectionClassName}>
            ...
            <p>
              Nima Aksoy Today may request currency rates from a server-side endpoint so the
          ...
          <section className={sectionClassName}>
            ...
            <p>
              Nima Aksoy Today does not use Google Calendar data or local note data for advertising,
          ...
          <section className={sectionClassName}>
            ...
            <p>
              You can disconnect Nima Aksoy Today&apos;s Google Calendar access from your Google
          ...
          <section className={sectionClassName}>
            ...
            <p>
              If Nima Aksoy Today&apos;s data practices change, this policy will be updated before
